...
public class PipeSpawner : MonoBehaviour
{
    ...
    private IEnumerator SpawnPipes()
    {
        ...
        {
            // 파이프를 생성할 임의의 y값 선택
            float positionY = Random.Range(-5.68f, 0.0f);
            // 아래 파이프 생성 위치
            ...
            // 아래 파이프 생성 위치
            Vector3 upPosition = new Vector3(4.7f, positionY + 2.0f, 0.0f);
            // 위 파이프 생성
            GameObject pipeUpClone = Instantiate(pipeDown, upPosition, Quaternion.identity);
